...
Public Class FlatCombo
    ...
    Private _borderColorFocused As Color = Color.FromArgb(0, 174, 231)
        ...
        If m.Msg = WM_PAINT Then
            ...
            Using g = Graphics.FromHwnd(Handle)
                ...
                If iStat = States.Normal Then
                    clr = _borderColor 'Color.Silver
                ElseIf iStat = States.Focused Then
                    clr = _borderColorFocused 'Color.FromArgb(0, 174, 231) 'Color.FromArgb(0, 0, 128)
                End If
                Using p = New Pen(clr)
